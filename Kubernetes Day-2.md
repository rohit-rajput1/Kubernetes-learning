...
![Pasted image 20240418010952.png]
...
![[Pasted image 20240418014821.png]]

## Kubernetes Architecture:

![[Drawing 2024-04-18 00.52.58.excalidraw 1.png]]
...
- Master Node has **5 component** are as follow:
	- ### kube-api-server:
		- ==kube-api-server Architecture:== ![[Pasted image 20240418180404.png]]
		...
		- **Admission Control:** Admission control in Kubernetes is a process that happens **after** authentication and before resources are created or modified within the cluster. It acts as an additional layer of security and validation.
			...
			- ==Admission Controller Architecture:== ![[Pasted image 20240418184937.png]]
	...
	- ### etcd:
		...
		- ==etcd Architecture:== ![[Pasted image 20240418195027.png]]
	...
	- ### kube-scheduler:
		...
		- ==kube-scheduler architecture:== ![[Pasted image 20240419151139.png]]
	...
	- ### kube-controller-manager:
		...
		- ==kube-controller-manager architecture:== ![[Pasted image 20240419160500.png]]
...
- Worker Node has **3 component** are as follow:
	- ==Worker Node Internal Working Architecture:== ![[Kubernetes2.png]]
	- ### pod:
	...
	- ### kubelet:
		- Kubelet, short for **Kubernetes Node Agent**, is a critical component that runs on each worker node within a Kubernetes cluster. It acts as the bridge between the Kubernetes control plane and the individual nodes, playing a central role in managing container lifecycles and ensuring the smooth operation of your pods.
			- ==Kubelet Cycle:== ![[Pasted image 20240420193032.png]]
...
---
**Blog:** [**Read this**](https://openai.com/research/scaling-kubernetes-to-7500-nodes)
